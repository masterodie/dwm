...
static const unsigned int gappx     = 5;       /* snap pixel */
...
static const char dmenufont[]       = "FiraCode Nerd Font:pixelsize=12:antialias=true:autohint=true";
...
static const char *shutdown[] = { "dmenu_shutdown", NULL };
